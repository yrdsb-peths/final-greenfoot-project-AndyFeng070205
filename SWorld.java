...
public class SWorld extends World
{
    ...
    public int scrolledX, scrolledY; // horizontal and vertical scrolled amounts
    ...
    public List<Actor>genActors = new ArrayList(); // lists all generic scrolling actor objects
